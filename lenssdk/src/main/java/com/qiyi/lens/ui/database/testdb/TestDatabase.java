...
class TestDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "lens.db";
    ...
    private TestDatabase() {
        super(ApplicationLifecycle.getInstance().getContext(), DATABASE_NAME, null, DATABASE_VERSION);
    }
    ...
    static <T> List<T> queryList(Class<T> clazz, String condition, String suffix) {
        ...
        try {
            Cursor cursor = TestDatabase.getRDb().rawQuery(sql, null);
