 ...
 */
public class LensTagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public LensTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LensTagFlowLayout);
        mAutoSelectEffect = ta.getBoolean(R.styleable.LensTagFlowLayout_auto_select_effect, true);
        mSelectedMax = ta.getInt(R.styleable.LensTagFlowLayout_max_select, -1);
        ta.recycle();
    ...
    public LensTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LensTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tagView.getLayoutParams() != null && tagView.getLayoutParams() instanceof MarginLayoutParams) {
//                tagViewContainer.setLayoutParams(tagView.getLayoutParams());
// 在7.0系统上,frameLayout中子view的margin生效了，7.0以下还不生效，兼容处理，统一把子view要求的margin拿到frameLayout上来measure
